      ...
      <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a routerLink="/home" class="text-gray-400 hover:text-white text-sm">Home</a></li>
              <li><a routerLink="/movies" class="text-gray-400 hover:text-white text-sm">Movies</a></li>
              <li><a routerLink="/subscriptions" class="text-gray-400 hover:text-white text-sm">Plans</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a routerLink="/support" class="text-gray-400 hover:text-white text-sm">Help Center</a></li>
              <li><a routerLink="/support" class="text-gray-400 hover:text-white text-sm">Contact Us</a></li>
        ...
        <div class="mt-12 pt-8 border-t border-gray-800">
          <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-gray-400 text-sm">
              © 2026 HubFlex. All rights reserved.
            </p>
